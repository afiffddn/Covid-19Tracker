			...
			<header id="header" class="skel-layers-fixed">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="http://covid-19.moh.gov.my/garis-panduan/garis-panduan-kkm"> SOP </a></li>
						<li><a href="https://www.who.int/health-topics/coronavirus#tab=tab_1"> About </a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					...
					<ul class="actions">
						<li><a href="About.php" class="button big special"> Track Covid-19 </a></li>
					</ul>
				</div>
			</section>
		...
		<!-- One -->
			<section id="one" class="wrapper style1">
				<header class="major">
					...
					<p style="color: grey; font-size: 15px;"> [STATS: 10/7/2020 3:20PM] </p>
				</header>
				<div class="container">
					<div class="row">
						<div class="4u">
